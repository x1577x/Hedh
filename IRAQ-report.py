...
╚═╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚══▀▀═╝ 
       ...
       [+]  : 𝐂𝐇𝐄𝐍𝐀𝐋 𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌  : @anay_hajy
       [+] 𝑻𝑬𝑳𝑬𝑮𝑹𝑨𝑴  : @A_iraqy01
    
""")
print('[+] 1- Hamw Reportakan? ')
print('[+] 2- Dyari Krdni Reportakan \n')
...
''')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req1:
            print('\033[1;92m[+] Bzhe tanya report rooy')
        else:
            print('\033[0;92m[+] bzhe tanya report royy')
        time.sleep(3)
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req2:
            print('\033[1;92m[+] bzhe tanya report royy')
        else:
            print('\033[0;31m[+] bzhe tanya report royy')
        time.sleep(3)
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req3:
            print('\033[0;92m[+] bzhe IRAQ report royy')
        else:
            print('\033[0;92m[+] bzhe IRAQ report royy')
if kurd == '2':
    print('''
...
if kurd2 == '3':
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req600:
            ...
            print('\033[0;92m[+] bzhe dark report royy')
