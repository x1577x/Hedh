...
output = render('TIK TOK', colors = [
    'white',
    'blue'], align = 'center')
print(output)
print('[+] 1- تقديم جميع انواع البلاغات')
print('[+] 2- تقديم بلاغ واحد\n')
D4NASR = input('\x1b[1;36m[+] Choose ==> : \x1b[0m')
if D4NASR == '1':
    time.sleep(1)
    print('\n[+] جميع البلاغات \n[+] البلاغ عن الكراهية \n[+] بلاغ عن انتحار\n')
    time.sleep(1)
    print('[!] تم اختيار جميع الانواع')
    time.sleep(1)
    print('')
    id1 = input('\x1b[1;36m[+] User Target • خلي يوزر الحساب ==> : \x1b[0m')
    ...
    if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req1:
        print('\x1b[1;92m[+]  تقرير عن الحساب')
    print('\x1b[0;92m[+]  تقرير اخر')
    time.sleep(3)
    ...
    if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req2:
        print('\x1b[1;92m[+]  تقرير اخر')
    print('\x1b[0;31m[+]  تقرير اخر')
    time.sleep(3)
...
if D4NASR == '2':
    print('\n[+] جميع البلاغات \n[+] البلاغ عن الكراهية \n[+] بلاغ عن انتحار\n')
Devil = input('\x1b[1;36m[+] Choose ==> : \x1b[0m')
if Devil == '1':
    username = input('\x1b[1;36m[+] User Target • خلي يوزر الحساب ==> : \x1b[0m')
    ...
    print('\x1b[0;92m[+]  تقرير اخر')
if Devil == '2':
    username2 = input('\x1b[1;36m[+] User Target • خلي يوزر الحساب ==> : \x1b[0m')
    ...
    print('\x1b[0;92m[+]  تقرير اخر')
if Devil == '3':
    username3 = input('\x1b[1;36m[+] User Target • خلي يوزر الحساب ==> : \x1b[0m')
